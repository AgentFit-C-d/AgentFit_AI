...
class FeatureSpanTests(unittest.TestCase):
    ...
    def test_feature_is_copied_from_source_not_generated_label(self):
        fields=self.candidate([{"lineId":1,"startText":"book","endText":"search"}])
    ...
    def test_missing_reversed_or_ambiguous_anchors_rejected(self):
        for doc,span in [
            ("book search",{"lineId":1,"startText":"missing","endText":"search"}),
            ("book search",{"lineId":1,"startText":"search","endText":"book"}),
            ("book book search",{"lineId":1,"startText":"book","endText":"search"})]:
    ...
    def test_feature_count_limit_is_not_silently_truncated(self):
        spans=[{"lineId":1,"startText":"book","endText":"search"}]*31
